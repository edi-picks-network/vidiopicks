      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#EC4899]/20 to-[#F472B6]/20 flex items-center justify-center">
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold text-[#F0F2FE] mb-6 flex items-center gap-2">
            <CheckCircle className="w-6 h-6 text-[#EC4899]" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-[#839BBE] hidden md:table-cell">
                        <div className="flex items-center gap-1">
                          <DollarSign className="w-3.5 h-3.5 text-[#F472B6]" />
                      ...
                      <td className="py-4 px-4 text-right">
                        <Link
                          href={`/tools/${tool.id}`}
                          className="inline-flex items-center gap-1 text-[#EC4899] hover:text-[#F472B6] transition-colors text-xs font-semibold"
                        >
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="font-bold text-[#F0F2FE] group-hover:text-[#EC4899] transition-colors truncate">
                        {tool.name}
                      </h3>
                  ...
                  <div className="text-xs text-[#F472B6] font-medium mb-3">
                    {tool.pricing}
                  </div>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                <summary className="px-6 py-4 cursor-pointer text-[#F0F2FE] font-semibold text-sm flex items-center justify-between group-open:text-[#F472B6] transition-colors">
                  {faq.q}
        ...
        <section className="bg-gradient-to-r from-[#162540] to-[#0F1F2D] border border-[#1E3A5F] rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {topTool && (
              <Link
                href={`/tools/${topTool.id}`}
                className="px-6 py-3 bg-[#EC4899] hover:bg-[#DB2777] text-white text-sm font-medium rounded-full transition-colors"
              >
