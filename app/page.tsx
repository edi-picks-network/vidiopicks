  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden hero-gradient">
        {/* Decorative blobs */}
        <div className="hero-glow w-[500px] h-[500px] -top-40 -right-20 bg-[#7C3AED]" />
        <div className="hero-glow w-[400px] h-[400px] -bottom-40 -left-20 bg-[#EC4899]" />
        <div className="hero-glow w-[300px] h-[300px] top-20 left-1/2 bg-[#06B6D4]" />
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-16 md:pt-28 md:pb-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-[#475569] max-w-xl mb-8 leading-relaxed">
              Hand-picked video creation and editing tools, reviewed and rated by our team.
              Discover the best software for your workflow.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.slice(0, 6).map((cat, i) => {
              ...
              const colors = [
                { bg: "#EEF2FF", icon: "#7C3AED", border: "#C4B5FD" },
                { bg: "#FDF2F8", icon: "#EC4899", border: "#F9A8D4" },
                { bg: "#ECFEFF", icon: "#06B6D4", border: "#67E8F9" },
              ...
              return (
                ...
                >
                  <div className="p-5">
                    ...
                    <h3 className="text-sm font-semibold text-[#0F172A] group-hover:text-[#7C3AED] transition-colors">
                      {cat.name}
                    </h3>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-2 bg-[#F1F5F9] rounded-lg p-1">
              <button
                ...
                className={`p-2 rounded-md transition-all ${
                  viewMode === "grid" ? "bg-white text-[#7C3AED] shadow-sm" : "text-[#94A3B8] hover:text-[#475569]"
                }`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-md transition-all ${
                  viewMode === "list" ? "bg-white text-[#7C3AED] shadow-sm" : "text-[#94A3B8] hover:text-[#475569]"
                }`}
              >
          ...
          <div className={viewMode === "grid"
            ...
            {editorPicks.map((tool, i) => {
              const colors = [
                { bg: "from-[#EEF2FF] to-[#F5F3FF]", border: "border-[#C4B5FD]/50" },
                { bg: "from-[#FDF2F8] to-[#FCE7F3]", border: "border-[#F9A8D4]/50" },
                { bg: "from-[#ECFEFF] to-[#CFFAFE]", border: "border-[#67E8F9]/50" },
                { bg: "from-[#FFF7ED] to-[#FFEDD5]", border: "border-[#FDBA74]/50" },
                { bg: "from-[#F0FDF4] to-[#DCFCE7]", border: "border-[#6EE7B7]/50" },
                { bg: "from-[#FEFCE8] to-[#FEF9C3]", border: "border-[#FDE68A]/50" },
              ];
              const color = colors[i % 6];
              ...
              return viewMode === "grid" ? (
                <Link
                  key={tool.id}
                  href={`/tools/${tool.id}`}
                  className={`card group overflow-hidden ${color.border}`}
                >
                  <div className={`aspect-[4/3] bg-gradient-to-br ${color.bg} flex items-center justify-center relative`}>
                    <div className="text-3xl font-bold text-[#0F172A]/10 select-none">
                      {tool.name.charAt(0)}
                    </div>
                    {i < 2 && (
                      <span className="absolute top-2 right-2 badge badge-pink shadow-sm text-[10px]">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-[#64748B] mt-1 line-clamp-1">{tool.description}</p>
                ...
                >
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${color.bg} flex items-center justify-center text-lg font-bold text-[#0F172A]/30 flex-shrink-0`}>
                    {tool.name.charAt(0)}
                  </div>
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    ...
                    <ChevronRight className="w-4 h-4 text-[#CBD5E1] group-hover:text-[#7C3AED] transition-colors" />
                  </div>
                </Link>
              );
            })}
              ...
              .map((tool, i) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#EEF2FF] text-[#7C3AED] text-sm font-bold">
                      #{i + 1}
                    </span>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold text-[#0F172A] group-hover:text-[#7C3AED] transition-colors truncate">
                        {tool.name}
                      </h3>
                    </div>
                    <div className="flex items-center gap-1">
              ...
              {latestPosts.map((post: any, i: number) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="text-sm font-semibold text-[#0F172A] group-hover:text-[#7C3AED] transition-colors line-clamp-2 mb-1">
                      {post.title}
                    </h3>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl p-10 md:p-14 text-center overflow-hidden hero-gradient border border-[#E2E8F0]">
            <div className="hero-glow w-[400px] h-[400px] -top-20 right-0 bg-[#7C3AED]" />
            <div className="hero-glow w-[300px] h-[300px] -bottom-20 left-0 bg-[#EC4899]" />
            <div className="relative">
              ...
              <p className="text-[#475569] mb-8 max-w-lg mx-auto">
                ...
                Compare features, read reviews, and make the right choice.
              </p>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#EEF2FF] mb-4">
            <Quote className="w-6 h-6 text-[#7C3AED]" />
          </div>
          <blockquote className="text-lg md:text-xl text-[#475569] leading-relaxed italic">
            &ldquo;VidioPicks saved me hours of research. The reviews are honest,
            the comparisons are detailed, and I found the perfect editing suite
            for my YouTube channel.&rdquo;
          </blockquote>
