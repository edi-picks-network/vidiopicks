                  ...
                  <div className="aspect-[4/3] bg-gradient-to-br flex items-center justify-center"
                    ...
                    {i < 2 && (
                      <span className="absolute top-2 right-2 text-[10px] px-2 py-0.5 rounded-full font-medium"
                        style={{ backgroundColor: `${accentColor}CC`, color: "white" }}>
                        Editor&apos;s Pick
                      </span>
                    )}
                  </div>
        ...
        <section className="px-6 py-10">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/blog" className="text-xs flex items-center gap-1" style={{ color: accentColor }}>
      ...
      <section className="px-6 py-14">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl p-10 text-center overflow-hidden"
            style={{ background: `linear-gradient(135deg, ${accentColor}20, ${secondaryColor}10)` }}>
            <div className="absolute inset-0 opacity-[0.03]"
              style={{ backgroundImage: `radial-gradient(circle at 30% 50%, ${accentColor}, transparent 60%)` }} />
            <div className="relative">
              <CheckCircle2 className="w-8 h-8 mx-auto mb-3" style={{ color: accentColor }} />
              <h2 className="text-xl font-bold text-white mb-2">
                Find your perfect video tools
              </h2>
              <p className="text-sm text-gray-500 mb-6">
                Browse our full collection of curated video creation and editing tools.
              </p>
              <Link
                href="/all-tools"
