...
export const metadata: Metadata = {
  title: "Terms of Service — VidioPics",
  description:
    "Read the Terms of Service for VidioPics. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#839BBE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the VidioPics website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              VidioPics is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by VidioPics and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of VidioPics. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by VidioPics. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              VidioPics offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, VidioPics, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless VidioPics and its
