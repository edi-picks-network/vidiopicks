    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-lg font-bold text-[#F0F2FE] group-hover:text-[#EC4899] transition-colors">
            VidioPicks
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button className="px-5 py-2 text-sm font-medium text-white bg-[#EC4899] hover:bg-[#DB2777] rounded-lg transition-colors shadow-glow-sm">
            Explore Tools
          </button>
        </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <nav className="px-6 py-4 flex flex-col gap-1">
            ...
            <button className="mt-2 px-5 py-3 text-sm font-medium text-white bg-[#EC4899] rounded-lg">
              Explore Tools
            </button>
          </nav>
        </motion.div>
