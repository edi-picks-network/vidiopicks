...
HeyGen combines enterprise-grade security (SOC 2 compliant), granular usage analytics, and collaborative workspaces--making it the go-to solution for teams prioritizing speed, personalization, and global reach without compromising quality.`,
  ...
  },
  {
    ...
    pricingDetail: "Free: 500MB/mo storage, 5GB bandwidth, watermark, basic analytics. Pro ($12/user/mo): 2TB storage, 4K streaming, AI transcription, Zapier. Business ($75/user/mo): unlimited storage/bandwidth, advanced analytics, SSO, custom domains. Enterprise (custom quote): dedicated infrastructure, BAA/SOC 2 reporting, SLA customization, and 24/7 concierge support.",
    features: [
